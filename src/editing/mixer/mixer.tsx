 ...
 * drum-instrument lane, freely interleavable. Drag-and-drop on each
...
export const MixerView = observer(
  ({
    ...
    // Drum lanes in mixer order. Pattern brackets are drawn on every
    // row whose lane participates in the pattern; this list lets each
    ...
    const laneOrder: readonly string[] = mixer?.laneOrder ?? [];
    ...
    return (
      <div className={styles.mixer}>
        ...
        {trackOrder.map((key, idx) => {
          ...
          // of a `groupId` cluster (paired audio↔lane today). Solo rows
