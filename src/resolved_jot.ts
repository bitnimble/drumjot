 ...
 * pixel-bearing `Resolved*` types, and the `RenderedJot` MobX container
 * that walks a source `Jot` into a structural cache and then a
 * per-zoom pixel layout (plus the drum beat-grid offset pass).
