...
export class SelectionStore {
  ...
  constructor(private readonly jotViewStore: JotViewStore) {
    ...
    // never appear. (`Set<StructNote>` now, but the same reasoning
