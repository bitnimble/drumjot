 ...
 * orchestration/actions moved onto `JotViewerPresenter`
 * (`./jot_viewer_presenter.ts`). These re-exports keep existing
 * `from './store'` import paths working for the shared types + helpers
 * that several files still pull from here.
 */
